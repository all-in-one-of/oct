    ...
    def addObj(self, obj=None, dagPath=None, activation=True, proba=0.5, align='Up'):
        ...
        if (self.alreadyExists(obj)):
            ...
            if (objtype in self.auth):
                ...
                #change by zwz
                elif (len(objchild) <= 2 and mc.nodeType(objchild[0]) in self.auth):
...
class spPaint3dWin (object):
    ...
    def __init__(self):
        ...
        mc.formLayout(self.uiPaintMetricsForm, edit=True,
                        ...
                        attachControl=[(self.uiPaintMetricsSep1, 'top', 5, self.uiPaintTimer), (self.uiPaintMetricsSep1, 'top', 23, self.uiPaintDistance), (self.uiUpOffset, 'top', 5, self.uiPaintMetricsSep1),(self.uiPaintMetricsRampMenu, 'top', 6, self.uiPaintMetricsSep1),(self.uiPaintMetricsRampMenu, 'left', 10, self.uiUpOffset),
