...
def makeMenu():
    ...
    mc.menuItem(d=1, parent="OCT_Generel")
    mc.menuItem('deleteUnknown', l=u'删除unknown节点(删除未知的节点)...', ann=u'删除unknown节点...', c='OCT_generel.deleteUnknown()', parent='OCT_Generel')
    ...
    mc.menuItem('deleteUnknown', l=u'删除unknown节点...', ann=u'删除unknown节点...', c='OCT_generel.deleteUnknown()', parent='OCT_Optimiza')
    ...
    mc.menuItem(d=1, parent="OCT_Optimiza")
    mc.menuItem('clearlightLinkerConnections_an', label=u'清理灯光连接', ann=u'清理灯光连接', to=True, c='mm.eval("clearlightLinkerConnections_zqs;")', parent="OCT_Generel")
    mc.menuItem(d=1, parent="OCT_Optimiza")
    ...
    mc.menuItem(d=1, parent= "OCT_Render")
    mc.menuItem('ClearUseAndDefer', l=u'清理节点和arnold代理延迟加载...', ann=u'清理节点和arnold代理延迟加载...', c='OCT_generel.ClearUseRanderDefer()', parent='OCT_Render')
