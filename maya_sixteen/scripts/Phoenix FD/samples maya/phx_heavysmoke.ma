...
//Name: phx_heavysmoke.ma
//Last modified: Mon, Apr 08, 2013 05:25:12 PM
//Codeset: 1251
requires maya "2011";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 51.661274022337153 11.585307742462831 -1.9968529945450015 ;
	setAttr ".r" -type "double3" 1.4616472703997259 90.600000000000847 0 ;
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr -k off ".v" no;
	setAttr ".fl" 34;
	setAttr ".coi" 48.387833006585133;
	...
	setAttr ".vrayCameraPhysicalFocalLength" 31.76788330078125;
	setAttr ".vrayCameraPhysicalFOV" 55.794540405273437;
...
createNode transform -n "PhoenixFDSim1";
	setAttr ".t" -type "double3" 6.4551028180497365 -3.5527136788005009e-015 -2.1333202249729659 ;
createNode PhoenixFDSimulator -n "PhoenixFDSimulator1" -p "PhoenixFDSim1";
	...
	setAttr ".rsor" -type "string" "D:\\PhoenixFD_cache\\phx_heavysmoke.ma_Phoenix2_frames\\@PhoenixFDSim1@PhoenixFDSimulator1_resim";
	setAttr ".rsir" -type "string" "D:\\PhoenixFD_cache\\phx_heavysmoke.ma_Phoenix2_frames\\@PhoenixFDSim1@PhoenixFDSimulator1";
	...
	setAttr ".tsc" 0.40000000596046448;
	setAttr ".vrt" 0.5;
	setAttr ".pd" 0;
	setAttr ".cool" 0;
	setAttr ".sb" 0;
	...
	setAttr ".opthr" -type "string" "D:\\PhoenixFD_cache\\phx_heavysmoke.ma_Phoenix2_frames\\@PhoenixFDSim1@PhoenixFDSimulator1";
	setAttr ".uset2f" no;
	setAttr ".t2f" 1;
	setAttr ".iro" 0;
	setAttr ".iml" 0;
	...
	setAttr ".ipthr" -type "string" "D:\\PhoenixFD_cache\\phx_heavysmoke.ma_Phoenix2_frames\\@PhoenixFDSim1@PhoenixFDSimulator1";
	setAttr ".ifyz" no;
	...
	setAttr ".vtt2" 10000;
	setAttr ".vs" yes;
	setAttr ".vsc" -type "float3" 0.33333334 0.33333334 0.33333334 ;
	setAttr ".vsc2" -type "float3" 0 0 0 ;
	setAttr ".vst" 0.0099999997764825821;
	setAttr ".vst2" 0.10000000149011612;
	setAttr ".vu" yes;
	setAttr ".vur" yes;
	...
	setAttr ".dm" no;
	setAttr ".simple_color" -type "float3" 0.87919432 0.87919432 0.87919432 ;
	...
	setAttr ".smoketransp" 0.69999998807907104;
	setAttr ".trl_t" 1700;
	setAttr ".tro_t" 300;
...
createNode transform -n "pCube2";
	setAttr ".t" -type "double3" -8.8897651161521054 26.388059207990587 -2.1530648149620992 ;
	setAttr ".s" -type "double3" 3.4216012706945542 0.69218482405646142 4 ;
createNode mesh -n "pCubeShape1" -p "pCube2";
	...
	setAttr ".cdvm[0]"  0 1 1;
	setAttr ".bnr" 0;
	setAttr -s 8 ".vt[0:7]"  -0.63849705 -2.8952227 4.2879038 0.63849705 
		-2.8952227 4.2879038 -0.63849705 2.8952227 4.2879038 0.63849705 2.8952227 4.2879038 
		-0.63849705 2.8952227 -4.2879038 0.63849705 2.8952227 -4.2879038 -0.63849705 -2.8952227 
		-4.2879038 0.63849705 -2.8952227 -4.2879038;
...
createNode transform -n "PhoenixFDSrc1";
	setAttr ".t" -type "double3" 3.1715233719673108 1.7763568394002505e-015 24.509273152546545 ;
	setAttr ".s" -type "double3" 7.8272873159253544 7.8272873159253544 7.8272873159253544 ;
createNode PhoenixFDSource -n "PhoenixFDSource1" -p "PhoenixFDSrc1";
	...
	setAttr ".tp" 10;
	setAttr ".tpm" 1;
	setAttr ".sm" 0.20000000298023224;
	setAttr ".smm" 1;
	setAttr ".uvm" 0;
	...
	setAttr ".mod[0].mro" -1;
	setAttr ".mod[0].mrs" 2;
	setAttr -s 2 ".mod[0].mr[0:1]"  -1 0 0 0 1 1;
	setAttr ".mod[0].ma" 0;
	setAttr ".mod[0].msp" 1;
	setAttr ".mod[0].mrv" 1;
	setAttr ".mod[1].ms" 1;
...
createNode VRayGeoSun -n "VRayGeoSun1" -p "transform1";
	setAttr ".t" -type "double3" -1.3511473003847065 36.579741747400824 -44.039097493780886 ;
	setAttr ".gyear" 2012;
	setAttr ".gmonth" 7;
	setAttr ".gday" 30;
	setAttr ".gdvalue" 212;
...
createNode VRaySunShape -n "VRaySunShape1" -p "VRayGeoSun1";
	...
	setAttr ".inv" yes;
	setAttr ".intens" 1.5;
	setAttr ".hillum" 40000;
	setAttr ".skymod" 2;
	setAttr ".photonRadius" 37.820514678955078;
createNode transform -n "PhoenixFDMap1";
	setAttr ".t" -type "double3" -15.29792148129744 3.5527136788005009e-015 13.310445614148747 ;
	setAttr ".s" -type "double3" 12.644687532253538 12.644687532253538 12.644687532253538 ;
...
createNode VRaySettingsNode -s -n "vraySettings";
	...
	setAttr ".aspl" no;
	setAttr ".vfbOn" yes;
	setAttr ".vfbSA" -type "Int32Array" 198 786 10 164 108 1324 871
		 1600 109 2 109 8406017 1 52 109 0 290 40 266
		 215 63 706 1 1 1 0 0 0 0 1 0
		 ...
		 0 15 0 785995872 0 -8487298 -8487298 -9013642 -9671572 0 0 0
		 ...
		 892481074 540094510 1701978236 1919247470 1835627552 807411813 807411816 908075117 7549742 16777216 16777216 0
	...
	setAttr ".mSceneName" -type "string" "C:/source/svn/Aura2/Maya/samples/phx_heavysmoke.ma";
...
select -ne :lightList1;
	setAttr -s 2 ".l";
select -ne :lambert1;
	setAttr ".c" -type "float3" 0.29451439 0.29451439 0.29451439 ;
...
connectAttr "VRayGeoSun1.iog" "phxlight_set1.dsm" -na;
connectAttr "pCube2.iog" "phxsource_set1.dsm" -na;
