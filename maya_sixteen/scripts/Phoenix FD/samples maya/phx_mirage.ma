...
//Name: phx_mirage.ma
//Last modified: Tue, Jul 02, 2013 07:23:14 PM
//Codeset: 1251
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 1.7208080957797434 1.2355908988171267 11.49386679344833 ;
	setAttr ".r" -type "double3" 1.4616472703912768 0.99999999999802991 -7.7662089090251074e-018 ;
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".coi" 16.005908973662656;
	setAttr ".imn" -type "string" "persp";
	setAttr ".den" -type "string" "persp_depth";
	setAttr ".man" -type "string" "persp_mask";
	setAttr ".hc" -type "string" "viewSet -p %camera";
	setAttr ".vrayCameraPhysicalOn" 1;
	setAttr ".vrayCameraPhysicalFocalLength" 28.719703674316406;
...
createNode camera -s -n "sideShape" -p "side";
	...
	setAttr ".o" yes;
createNode transform -n "simulation";
	setAttr ".t" -type "double3" 2 0.01 2 ;
createNode PhoenixFDSimulator -n "PhoenixFDSimulator1" -p "simulation";
	setAttr ".cch" no;
	setAttr ".ihi" 2;
	setAttr ".nds" 0;
	setAttr ".isc" no;
	...
	setAttr ".rsor" -type "string" "D:\\PhoenixFD_cache\\phx_mirage.ma_Phoenix2_frames\\@simulation@PhoenixFDSimulator1_resim";
	setAttr ".rsir" -type "string" "D:\\PhoenixFD_cache\\phx_mirage.ma_Phoenix2_frames\\@simulation@PhoenixFDSimulator1";
	...
	setAttr ".opthr" -type "string" "D:\\PhoenixFD_cache\\phx_mirage.ma_Phoenix2_frames\\@simulation@PhoenixFDSimulator1";
	setAttr ".uset2f" no;
	setAttr ".t2f" 1;
	setAttr ".iro" 0;
	setAttr ".iml" 0;
	...
	setAttr ".ipthr" -type "string" "D:\\PhoenixFD_cache\\phx_mirage.ma_Phoenix2_frames\\@simulation@PhoenixFDSimulator1";
	setAttr ".ifyz" no;
	...
	setAttr ".displ2" -type "float3" 0.030703574 0.030703574 0.030703574 ;
	...
	setAttr ".trl_t" 1700;
	setAttr ".tro_t" 300;
	setAttr ".trm_t" 0.05000000074505806;
	...
	setAttr -s 14 ".epower_f[0:13]"  0.55000001 25.51508141 3 0.58071911
		 ...
		 243318.21875 3 1.000000476837 483980.125 3 0.98714346 412181.71875 3 0.99775058
		 470705.03125 3;
	setAttr -s 9 ".tpower_t[0:8]"  300 0 3 929 0.0125 3 1071.80004883
		 0.027000001 3 1105.80004883 0.050000001 3 1107.5 0.050000001 1 1145.75 0 
		3 1575 0 3 1745 0.025 3 2000 0 3;
...
createNode transform -n "source1";
	setAttr ".t" -type "double3" -8.4234942610708359 -3.5527136788005009e-015 0.19034537373062932 ;
	setAttr ".s" -type "double3" 3.4000000953674316 3.4000000953674316 3.4000000953674316 ;
createNode PhoenixFDSource -n "PhoenixFDSource1" -p "source1";
	setAttr ".cch" no;
	setAttr ".ihi" 2;
	setAttr ".nds" 0;
	setAttr ".isc" no;
	...
	setAttr ".mode" 0;
	setAttr ".dc" 0.039999999105930328;
	setAttr ".dcm" 0.032546158879995346;
	setAttr ".tp" 600;
	setAttr ".tpm" 1;
	setAttr ".sm" 1;
	setAttr ".smm" 1;
...
createNode transform -n "pPlane1";
	setAttr ".t" -type "double3" 2 0.05 -1 ;
	setAttr ".it" no;
...
createNode transform -n "pTorus1";
	setAttr ".t" -type "double3" -1.3608490634251855 0.77514106556190132 -7.1388811801320031 ;
...
createNode transform -n "pPyramid1";
	setAttr ".t" -type "double3" 2.6229233137801535 1.3690084941503784 -7.7238017541028894 ;
...
createNode transform -n "pCylinder1";
	setAttr ".t" -type "double3" 6.7256838489973818 1.0978484026622417 -7.4314527272212061 ;
...
createNode VRayGeoSun -n "VRayGeoSun1" -p "transform3";
	setAttr ".t" -type "double3" 0.46368861973063014 4.7788794254640621 -15.595929464690114 ;
	setAttr ".gyear" 2011;
	setAttr ".gmonth" 6;
	setAttr ".gday" 21;
	setAttr ".gdvalue" 172;
...
createNode place3dTexture -n "place3dTexture1";
	setAttr ".t" -type "double3" 2 1.3220000362396238 -1 ;
	setAttr ".s" -type "double3" 7.5 1.312000036239624 10 ;
createNode transform -n "directionalLight1";
	setAttr ".t" -type "double3" 0 0.61242388738429376 0 ;
	setAttr ".r" -type "double3" -10.371822262608472 5.2329476701611357 -0.95634582584497185 ;
...
createNode VRaySettingsNode -s -n "vraySettings";
	...
	setAttr ".ints" 0.3;
	setAttr ".caoet" yes;
	setAttr ".vrscfile" -type "string" "C:/test.vrscene";
	setAttr ".srgx" 16;
	setAttr ".srgy" 16;
	setAttr ".wi" 1280;
	setAttr ".he" 720;
	...
	setAttr ".vfbSA" -type "Int32Array" 198 786 10 -2 -2 1860 1063
		 1600 102 0 102 8406017 1 0 0 0 0 0 0
		 ...
		 24941 21367144 0 1068524160 0 16 1 1 8 1068581344 0 1
		 268464164 560247552 0 1014953984 -1071502532 16825856 0 36954717 0 36954709 0 21367144
		 ...
		 892350003 540094510 1701978236 1919247470 1835627552 807411813 807411816 941629549 7551278 16777216 16777216 0
	...
	setAttr ".mSceneName" -type "string" "C:/source/svn/Aura2/Maya/samples/phx_mirage.ma";
...
createNode polyCylinder -n "polyCylinder1";
	setAttr ".r" 0.95796908691545501;
	setAttr ".h" 1.807060258612593;
	setAttr ".sc" 1;
	setAttr ".cuv" 3;
...
createNode volumeNoise -n "volumeNoise1";
	setAttr ".ra" 0.83211678266525269;
	setAttr ".fr" 3.824817419052124;
	setAttr ".nty" 0;
select -ne :time1;
	setAttr -av -k on ".cch";
	setAttr -cb on ".ihi";
...
select -ne :lightList1;
	setAttr -s 3 ".l";
select -ne :lambert1;
	setAttr ".c" -type "float3" 0.69099998 0.69099998 0 ;
...
connectAttr "noise1.oa" "PhoenixFDSource1.dcm";
