...
//Name: phx_checker.ma
//Last modified: Wed, May 15, 2013 06:39:22 PM
//Codeset: 1251
requires maya "2011";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -6.4335081759539046 5.6453476157600839 12.678823976677563 ;
	setAttr ".r" -type "double3" -15.938352729607907 -22.600000000000087 4.3063792819169593e-016 ;
createNode camera -s -n "perspShape" -p "persp";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 16.24419880802062;
...
createNode transform -n "transform1";
	setAttr ".t" -type "double3" -1.6343843248282255 0 -1.8715980902869145 ;
createNode PhoenixFDSimulator -n "PhoenixFDSimulator1" -p "transform1";
	...
	setAttr ".rsor" -type "string" "D:\\PhoenixFD_cache\\phx_checker.ma_Phoenix2_frames\\@transform1@PhoenixFDSimulator1_resim";
	setAttr ".rsir" -type "string" "D:\\PhoenixFD_cache\\phx_checker.ma_Phoenix2_frames\\@transform1@PhoenixFDSimulator1";
	...
	setAttr ".opthr" -type "string" "D:\\PhoenixFD_cache\\phx_checker.ma_Phoenix2_frames\\@transform1@PhoenixFDSimulator1";
	setAttr ".uset2f" no;
	setAttr ".t2f" 1;
	setAttr ".iro" 0;
	setAttr ".iml" 1;
	...
	setAttr ".ipthr" -type "string" "D:\\PhoenixFD_cache\\phx_checker.ma_Phoenix2_frames\\@transform1@PhoenixFDSimulator1";
	setAttr ".ifyz" no;
	...
	setAttr ".dm" no;
	setAttr ".simple_color" -type "float3" 0.94674599 0.94674599 0.94674599 ;
	setAttr ".pmbounces" yes;
	setAttr ".lightcache" no;
	...
	setAttr ".trl_t" 1;
	setAttr ".tro_t" 0;
	setAttr ".trm_t" 0.60000002384185791;
	...
	setAttr -s 14 ".epower_f[0:13]"  0.55000001 25.515081 3 0.58071911 
		...
		0.84955209 55141.309 3 0.89700198 118026.08 3 0.94710219 243318.22 3 1.0000005 
		483980.09 3 0.98714346 412181.72 3 0.99775058 470705.03 3;
	setAttr -s 2 ".tpower_t[0:1]"  0.726542 0.60000002 3 0.57640702 
		0 3;
	setAttr -s 9 ".tpower_s[0:8]"  0.14 0 3 0.43599999 0.025 3 
...
createNode transform -n "transform2";
	setAttr ".t" -type "double3" 5.5265310658335292 1.7763568394002505e-015 1.0738028383609404 ;
	setAttr ".s" -type "double3" 4.9164474989484761 4.9164474989484761 4.9164474989484761 ;
createNode PhoenixFDMapper -n "PhoenixFDMapper1" -p "transform2";
	setAttr -k off ".v";
createNode place3dTexture -n "place3dTexture1";
	setAttr ".t" -type "double3" -1.6010260082731942 3.4325294550452972 0.31434805123850307 ;
	setAttr ".s" -type "double3" 2 2 2 ;
createNode transform -n "directionalLight1";
	setAttr ".t" -type "double3" -6.541490605870977 4.1618798820975185 -3.8060237621173965 ;
	setAttr ".r" -type "double3" -23.602722923423137 -57.001974565588476 0 ;
...
createNode VRaySettingsNode -s -n "vraySettings";
	...
	setAttr ".mSceneName" -type "string" "C:/source/svn/Aura2/Maya/samples/phx_checker.ma";
...
createNode hyperView -n "hyperView1";
	setAttr ".vl" -type "double2" -114.28571428571429 -436.90476190476198 ;
	setAttr ".vh" -type "double2" 655.95238095238108 30.952380952380956 ;
	setAttr ".dag" no;
...
connectAttr "projection1.oc" "PhoenixFDMapper1.mp";
