...
class newMergeCam():
    def __init__(self):
        self.mode = 1
        self.numSelect = 0
        self.num = {'A': 1, '1L': 1, '1R': 1, 'B': 2, '2L': 2, '2R': 2, 'C': 3, '3L': 3, '3R': 3, 'D': 4, 'E': 5,
                    'F': 6, 'G': 7, 'H': 8, 'I': 9}

        self.num4 = {'1_A': 1, '1_B': 2, '1_C': 3, '2_A': 4, '2_B': 5, '2_C': 6, }

        self.num6 = {'1_A': 1, '_1_A': 1, '1_B': 2, '_1_B': 2, '1_C': 3, '_1_C': 3, '1_D': 4, '_1_D': 4, '2_A': 5,
                     '_2_A': 5, '2_B': 6, '_2_B': 6, '2_C': 7, '_2_C': 7, '2_D': 8, '_2_D': 8, '3_A': 9, '_3_A': 9,
                     '3_B': 10, '_3_B': 10, '3_C': 11, '_3_C': 11, '_3_D': 12, '3_D': 12}

        self.FKBSNum6 = {'1_A': 1, '_1_A': 1, '1_B': 2, '_1_B': 2, '1_C': 3, '_1_C': 3, '1_E': 4, '_1_E': 4, '1_F': 5,
                         '_1_F': 5, '1_G': 6, '_1_G': 6}

        self.SGFCNum5 = {'1_A': 1, '_1_A': 1, '1_B': 2, '_1_B': 2, '1_C': 3, '_1_C': 3, '2_A': 4, '_2_A': 4, '2_B': 5,
    ...
    def mergeCams_dntg(self, sourceSels, flag, FileName):
        ...
        for each in sourceSels:
            ...
            camStr = self.checkFile(each, FileName)
            rndlyer.append(self.stuff_info(each)["rndLayer"])
            rndCam.append(self.stuff_info(each)["rndCam"])
    ...
    def stuff_info(self, nknd):  # add by zhangben 2018 12 13   get stuff camera,render layer informations========
