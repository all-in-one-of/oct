...
//Name: phx_surf.ma
//Last modified: Wed, Jul 03, 2013 04:21:09 PM
//Codeset: 1251
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -9.1324345295328673 1.8364299235609287 8.6616460381193257 ;
	setAttr ".r" -type "double3" 2.8616472703921469 -47.800000000005241 -2.9593356337616479e-016 ;
	setAttr ".rp" -type "double3" 4.6351811278100286e-015 -4.4408920985006262e-016 -1.7763568394002505e-015 ;
	setAttr ".rpt" -type "double3" -4.3059473330903203e-016 8.5129018585426636e-017 
		4.1137136621771485e-015 ;
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".sos" 0;
	setAttr ".fl" 25.472297595049465;
	setAttr ".coi" 18.297957114663006;
	...
	setAttr ".vrayCameraPhysicalFocalLength" 30.153192520141602;
	setAttr ".vrayCameraPhysicalSpecifyFOV" 2;
	setAttr ".vrayCameraPhysicalFOV" 53.000022888183594;
...
createNode PhoenixFDSimulator -n "PhoenixFDSimulator1" -p "PhoenixFDSim1";
	...
	setAttr ".rsor" -type "string" "D:\\PhoenixFD_cache\\phx_surf.ma_Phoenix2_frames\\@PhoenixFDSim1@PhoenixFDSimulator1_resim";
	setAttr ".rsir" -type "string" "D:\\PhoenixFD_cache\\phx_surf.ma_Phoenix2_frames\\@PhoenixFDSim1@PhoenixFDSimulator1";
	...
	setAttr ".mun" 4;
	setAttr ".uns" 1;
	setAttr ".csz" 0.05000000074505806;
	setAttr ".xsz" 128;
	setAttr ".ysz" 128;
	setAttr ".zsz" 128;
	setAttr ".bx" 3;
	...
	setAttr ".spsizevar" 2.5;
	setAttr ".spszdstrb" 40;
	setAttr ".airfr" 1;
	setAttr ".sp2foam" 0.25;
	...
	setAttr ".opthr" -type "string" "D:\\PhoenixFD_cache\\phx_surf.ma_Phoenix2_frames\\@PhoenixFDSim1@PhoenixFDSimulator1";
	setAttr ".uset2f" no;
	setAttr ".t2f" 1;
	setAttr ".iro" 0;
	setAttr ".iml" 0;
	...
	setAttr ".ipthr" -type "string" "D:\\PhoenixFD_cache\\phx_surf.ma_Phoenix2_frames\\@PhoenixFDSim1@PhoenixFDSimulator1";
	setAttr ".ifyz" no;
	...
	setAttr ".vma" 0.61834317445755005;
	setAttr ".vmas" yes;
	setAttr ".rsl_x" 0.5;
	setAttr ".rsl_t" 0.5;
	setAttr ".rsl_s" 0.5;
	...
	setAttr ".dm" no;
	setAttr ".simple_color" -type "float3" 0.37454399 0.46952638 0.61199999 ;
	...
	setAttr -s 14 ".epower_t[0:13]"  1100 25.6639595 3 1161.43823242
		 78.19976044 3 1226.30786133 234.010299683 3 1294.80078125 656.81231689 3
		 1367.11901855 1738.69433594 3 1443.4765625 4382.20507813 3 1524.098999023 10623.23925781 
		3 1609.22424316 24698.68164063 3 1699.10412598 55234.6875 3 1794.00390625
		 118336.1015625 3 1894.2043457 243772.59375 3 2000.0010986328 483977.1875 3
		 1974.28686523 410513.09375 3 1995.50109863 473241.15625 3;
	setAttr -s 14 ".epower_s[0:13]"  0.55000001 25.6639595 3 0.58071911
		 78.19976044 3 0.61315393 234.010299683 3 0.64740038 656.81231689 3 0.68355954
		 1738.69433594 3 0.72173828 4382.20507813 3 0.7620495 10623.23925781 3 0.8046121
		 24698.68164063 3 0.84955209 55234.6875 3 0.89700198 118336.1015625 3 0.94710219
		 243772.59375 3 1.000000476837 483977.1875 3 0.98714346 410513.09375 3 0.99775058
		 473241.15625 3;
	setAttr -s 14 ".epower_v[0:13]"  220 25.6639595 3 232.28764343 78.19976044 
		3 245.26156616 234.010299683 3 258.96014404 656.81231689 3 273.42379761 1738.69433594 
		3 288.6953125 4382.20507813 3 304.8197937 10623.23925781 3 321.84484863 24698.68164063 
		3 339.8208313 55234.6875 3 358.80078125 118336.1015625 3 378.84088135 243772.59375 
		3 400.00021362305 483977.1875 3 394.85739136 410513.09375 3 399.10021973
		 473241.15625 3;
	setAttr -s 14 ".epower_f[0:13]"  0.55000001 25.6639595 3 0.58071911
		 78.19976044 3 0.61315393 234.010299683 3 0.64740038 656.81231689 3 0.68355954
		 1738.69433594 3 0.72173828 4382.20507813 3 0.7620495 10623.23925781 3 0.8046121
		 24698.68164063 3 0.84955209 55234.6875 3 0.89700198 118336.1015625 3 0.94710219
		 243772.59375 3 1.000000476837 483977.1875 3 0.98714346 410513.09375 3 0.99775058
...
createNode VRaySunTarget -n "VRaySunTarget1" -p "transform2";
	setAttr -k off ".v";
createNode VRayGeoSun -n "VRayGeoSun1" -p "transform2";
	setAttr ".t" -type "double3" -6.3394307416075186 11.690823516408209 -4.5335928043404703 ;
	setAttr ".gdist" 1000;
	setAttr ".gyear" 2011;
	setAttr ".gmonth" 6;
	setAttr ".gday" 7;
...
createNode VRaySunShape -n "VRaySunShape1" -p "VRayGeoSun1";
	setAttr -k off ".v";
	setAttr ".inv" yes;
	setAttr ".intens" 1.3999999761581421;
	setAttr ".hillum" 60000;
	setAttr ".skymod" 2;
	setAttr ".subdivs" 3;
	setAttr ".photonRadius" 7.3170733451843262;
	setAttr ".csubs" 700;
createNode transform -n "PhoenixFDFm1";
	setAttr ".t" -type "double3" -3.4365677598033977 0 4.0860050129827465 ;
...
createNode transform -n "PhoenixFDFm2";
	setAttr ".t" -type "double3" -1.7332420027796274 0 4.4967916402446653 ;
createNode PhoenixFDFoam -n "PhoenixFDFoam2" -p "PhoenixFDFm2";
	addAttr -ci true -h true -sn "aal" -ln "attributeAliasList" -dt "attributeAlias";
	setAttr -k off ".v";
	setAttr ".vir" yes;
	setAttr ".vif" yes;
	setAttr ".col" -type "float3" 0.4007782 0.45270467 0.45270467 ;
	setAttr ".bnc" 1;
	setAttr ".dm" 0.15000000596046448;
	setAttr ".hlw" 0.10000000149011612;
	setAttr ".hlm" 0;
	setAttr ".sm" 1.7999999523162842;
	setAttr ".sct" 3;
	setAttr ".mod" 2;
	setAttr ".mob" 1;
	setAttr ".vm" 0.30000001192092896;
	setAttr ".opt" no;
	setAttr ".nls" yes;
	setAttr ".rme" yes;
...
createNode transform -n "PhoenixFDMap1";
	setAttr ".t" -type "double3" -4.517092511686787 -8.8817841970012523e-016 0.015507276207333833 ;
	setAttr ".s" -type "double3" 1.8097522817313427 1.8097522817313427 1.8097522817313427 ;
createNode PhoenixFDMapper -n "PhoenixFDMapper1" -p "PhoenixFDMap1";
	setAttr -k off ".v";
	setAttr ".mp" -type "float3" 1 1 1 ;
	setAttr ".rX" -type "long2" 0 50 ;
	setAttr ".rZ" -type "long2" 0 33 ;
createNode place3dTexture -n "place3dTexture1";
createNode transform -n "persp1";
	setAttr ".t" -type "double3" -0.81004469645612787 3.1520950077204755 6.0069989837078186 ;
	setAttr ".r" -type "double3" -7.5383527295973485 -384.99999999998158 4.3866922569738798e-016 ;
createNode camera -n "perspShape2" -p "persp1";
	setAttr -k off ".v";
	setAttr ".rnd" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 7.4881412306504753;
...
createNode VRaySettingsNode -s -n "vraySettings";
	setAttr ".rfc" yes;
	setAttr ".se" 0;
	setAttr ".csd" 0.10000000149011612;
	setAttr ".aafon" no;
	setAttr ".dma" 5;
	setAttr ".sma" 1;
	setAttr ".imcp" 1;
	...
	setAttr ".caoet" yes;
	setAttr ".cavte" yes;
	setAttr ".vrscfile" -type "string" "c:/phx_surf.vrscene";
	setAttr ".srgx" 32;
	setAttr ".srgy" 32;
	setAttr ".sltp" yes;
	setAttr ".wi" 1920;
	...
	setAttr ".aspl" no;
	setAttr ".fnprx" -type "string" "D:\\render\\surf\\surf";
	setAttr ".pxa" 0.99956250190734863;
	setAttr ".bkc" -type "string" "map1";
	setAttr ".vfbOn" yes;
	setAttr ".vfbSA" -type "Int32Array" 198 786 10 1 1 1238 734
		 1312 451 308 451 50433 1 358 451 0 242 475 247
		 358 63 706 1 1 1 0 0 0 0 1 0
		 ...
		 24941 353367696 0 353367872 0 353368048 0 353368136 0 353368312 0 353368400
		 0 353368576 0 353368752 0 353368928 0 353369104 0 353369280 0 353369368
		 ...
		 892350003 540094510 1701978236 1919247470 1835627552 807411813 807411816 807411821 7551278 16777216 16777216 0
	...
	setAttr ".stampOn" yes;
	setAttr ".mSceneName" -type "string" "C:/source/svn/Aura2/Maya/samples/phx_surf.ma";
...
createNode PhoenixFDOceanTexture -n "PhoenixFDOceanTexture1";
	addAttr -ci true -h true -sn "vpi" -ln "vrayPluginInfo" -dv 3.6350130493998102e-315 
		-at "addr";
...
select -ne :lightList1;
	setAttr -s 2 ".l";
select -ne :lambert1;
	setAttr ".c" -type "float3" 0.31883726 0.31883726 0.31883726 ;
...
connectAttr "multiplyDivide1.o" "PhoenixFDFoam1.em";
connectAttr "PhoenixFDSimulator1.avo" "PhoenixFDFoam1.lg";
connectAttr "phxfoam_set2.ub[0]" "PhoenixFDFoam2.pss";
connectAttr "multiplyDivide1.o" "PhoenixFDFoam2.em";
connectAttr "PhoenixFDSimulator1.avo" "PhoenixFDFoam2.lg";
connectAttr "VRaySky1.oc" "PhoenixFDFoam2.rm";
...
connectAttr "VRaySky1.oc" "multiplyDivide1.i1";
